define(['jquery', 'underscore', 'backbone', 'text!template/form.html', 'file_upload', 'router', 'model/applicant', 'fileUpload', 'jquery.iframe-transport'], function ($, _, Backbone, template, fileUpload, Router, applicantModel, upload, fileUploadIframe) {
