define(['jquery', 'underscore', 'backbone', 'jquery.iframe-transport', 'jquery.ui.widget', 'fileupload', 'model/session', 'api_config', "core-js/modules/es6.array.find", "core-js/modules/es6.function.name", "core-js/modules/es7.array.includes", "core-js/modules/es6.string.includes"], function ($, _, Backbone, fileUploadIframe, fileUploadUI, fileupload, Session, api_config, _es6Array, _es6Function, _es7Array, _es6String) {
  var uploadData = {};
  var jqXHR = {};
    ...
    $('input[type=file]').each(function (index) {
      ...
      $(this).fileupload({
        ...
        progress: function progress(e, data) {
          ...
          if (progress == 100) {// Backbone.Events.trigger('success')
          }
        },
