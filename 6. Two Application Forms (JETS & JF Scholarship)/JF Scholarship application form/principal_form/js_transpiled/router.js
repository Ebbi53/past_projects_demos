define(['jquery', 'underscore', 'backbone', 'model/applicant', 'api_config', "core-js/modules/es6.regexp.search"], function ($, _, Backbone, applicantModel, api_config, _es6Regexp) {
