...
require.config({
    ...
    paths: {
        ...
        'datepicker': '../plugin/datepicker/js/bootstrap-datepicker',
        'select2': '../lib/select2-4.0.8/dist/js/select2',
